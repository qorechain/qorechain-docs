...
:::note
Set `--chain-id qorechain-vladi` to broadcast against the live mainnet (chain version **v3.1.95**), or `--chain-id qorechain-diana` for the testnet. If omitted, the client uses the `chain-id` from your local config.
:::
