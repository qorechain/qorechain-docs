...
:::note
The `qor_` namespace is available on the **`qorechain-vladi`** mainnet (EVM chain ID **9801**, live on chain version **v3.1.92**) and the **`qorechain-diana`** testnet (EVM chain ID **9800**). Examples below assume a local node; substitute your provider's mainnet or testnet endpoint for remote access.
:::
