...
:::note
The figures on this page describe the **mainnet** (`qorechain-vladi`, EVM chain ID **9801**), live since 7 June 2026 on chain version **v3.1.70**. The **`qorechain-diana`** testnet (EVM chain ID **9800**) shares the same economic model.
:::
