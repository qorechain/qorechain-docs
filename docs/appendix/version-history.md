...
* **Client tooling** — `@qorechain/wallet-adapter` 0.1.4 adds eth-native Cosmos signing (`signClassicalEth` / `signHybridEth`) alongside unified 3-address generation; `@qorechain/chain-bridge` gains an `eth_secp256k1` signing path.
