...
| -------------------------- | ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PQC Hybrid Signatures      | v1.1.0 (Security)   | Dual Ed25519 + ML-DSA-87 (Dilithium-5) signatures on every transaction. Three governance-controlled enforcement modes: disabled (classical only), optional (PQC verified if present, classical fallback), and required (both signatures mandatory). Seamless wallet onboarding via TX extension auto-registration.                                                                              |
