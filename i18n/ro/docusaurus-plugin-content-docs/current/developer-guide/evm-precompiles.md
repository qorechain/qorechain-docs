...
:::note
Precompilatele sunt disponibile atât pe rețeaua principală (mainnet) **`qorechain-vladi`** (EVM chain ID **9801**, activă din 7 iunie 2026 pe versiunea de lanț **v3.1.77**), cât și pe rețeaua de test (testnet) **`qorechain-diana`** (EVM chain ID **9800**). Toate exemplele folosesc endpoint-ul JSON-RPC pe **portul 8545**.
:::
