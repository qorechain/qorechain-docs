...
:::note
Comenzile de mai jos folosesc mainnet-ul **`qorechain-vladi`**, activ din 7 iunie 2026, rulând versiunea de lanț **v3.1.85**. Înlocuiește cu `--chain-id qorechain-diana` pentru testnet.
:::
