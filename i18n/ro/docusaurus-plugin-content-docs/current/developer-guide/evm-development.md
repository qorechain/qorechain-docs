...
:::note
Exemplele de mai jos vizează rețeaua mainnet **`qorechain-vladi`** (chain ID EVM **9801**), activă din 7 iunie 2026, rulând versiunea de chain **v3.1.92**. Pentru testnet-ul **`qorechain-diana`**, folosiți chain ID EVM **9800**.
:::
