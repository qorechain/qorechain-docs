...
:::note
Exemplele de mai jos vizează rețeaua principală (mainnet) **`qorechain-vladi`** (EVM chain ID **9801**), activă din 7 iunie 2026 rulând versiunea de lanț **v3.1.82**. Pentru rețeaua de test (testnet) **`qorechain-diana`**, folosiți EVM chain ID **9800**.
:::
