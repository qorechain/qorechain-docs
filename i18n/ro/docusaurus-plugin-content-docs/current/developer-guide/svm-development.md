...
:::note
Comenzile de mai jos folosesc rețeaua mainnet **`qorechain-vladi`**, live din 7 iunie 2026, rulând versiunea de chain **v3.1.92**. Înlocuiți cu `--chain-id qorechain-diana` pentru testnet.
:::
