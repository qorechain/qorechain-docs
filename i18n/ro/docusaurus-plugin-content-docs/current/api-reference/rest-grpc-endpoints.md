...
:::note
Aceste interfețe sunt disponibile atât pe mainnet-ul **`qorechain-vladi`** (live din 7 iunie 2026, pe versiunea de chain **v3.1.97**), cât și pe testnet-ul **`qorechain-diana`**. URL-urile de bază de mai jos presupun un nod care rulează local; punctele finale publice găzduite (`rpc/api/evm/svm.qore.host` și variantele lor `-testnet`) sunt listate în [Rețele](/appendix/networks#public-endpoints).
:::
