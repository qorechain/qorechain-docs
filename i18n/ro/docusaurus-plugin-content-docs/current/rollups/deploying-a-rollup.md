...
:::note
Comenzile de mai jos vizează testnet-ul **`qorechain-diana`**. Mainnet-ul (**`qorechain-vladi`**, EVM chain ID **9801**) este live din 7 iunie 2026, rulând versiunea de chain **v3.1.77** — înlocuiește chain ID-ul și endpoint-urile de mainnet când implementezi pe mainnet. Validează fiecare implementare mai întâi pe testnet.
:::
