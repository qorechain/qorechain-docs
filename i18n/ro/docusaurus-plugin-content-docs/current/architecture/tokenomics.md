...
:::note
Cifrele de pe această pagină descriu **mainnet-ul** (`qorechain-vladi`, EVM chain ID **9801**), live din 7 iunie 2026 pe versiunea de lanț **v3.1.77**. Testnet-ul **`qorechain-diana`** (EVM chain ID **9800**) folosește același model economic.
:::
