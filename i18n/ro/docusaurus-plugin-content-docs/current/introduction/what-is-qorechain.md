...
Rețeaua principală (`qorechain-vladi`, EVM chain ID **9801**) este activă din 7 iunie 2026 și rulează versiunea de lanț **v3.1.77**. O rețea de test publică (`qorechain-diana`, EVM chain ID **9800**) rulează în paralel pentru staging și testare de integrare. Token-ul nativ este **QOR** (afișare) / **uqor** (bază, 10^6), cu prefixele Bech32 `qor` pentru conturi și `qorvaloper` pentru validatori. Lanțul este construit pe Cosmos SDK v0.53.
