...
| **Un cont finanțat a dispărut din „Conturile tale”** | Nimic nu este pierdut — fiecare cont se re-derivă din fraza ta de recuperare, deci este o problemă de afișare, nu o pierdere de date. Aceasta a fost o eroare reală, acum reparată, în versiunile mobile de dinainte de **1.0.9**: o citire eșuată de moment din stocarea securizată a dispozitivului (cel mai probabil chiar la deblocare) putea afișa o listă de conturi scurtată. Actualizează la 1.0.9 sau ulterior; dacă ești deja la zi și acest lucru se întâmplă, închiderea și redeschiderea aplicației ar trebui să îl aducă înapoi — apăsarea pe „adaugă un cont” ar crea un cont **nou** în loc să restaureze cel lipsă, așa că evită acest lucru până când contul existent reapare. |
