...
:::note
このページの数値は、チェーンバージョン **v3.1.80** で 2026 年 6 月 7 日以降稼働している**メインネット** (`qorechain-vladi`、EVM チェーン ID **9801**) を説明しています。**`qorechain-diana`** テストネット (EVM チェーン ID **9800**) は同じ経済モデルを共有しています。
:::
