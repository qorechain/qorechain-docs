...
:::note
プリコンパイルは、**`qorechain-vladi`** メインネット（EVMチェーンID **9801**、2026年6月7日よりチェーンバージョン **v3.1.95** で稼働中）と **`qorechain-diana`** テストネット（EVMチェーンID **9800**）の両方で利用できます。すべての例は **ポート8545** のJSON-RPCエンドポイントを使用します。
:::
