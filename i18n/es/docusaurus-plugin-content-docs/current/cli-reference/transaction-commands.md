...
:::note
Establece `--chain-id qorechain-vladi` para transmitir contra la mainnet en vivo (versión de la cadena **v3.1.97**), o `--chain-id qorechain-diana` para la testnet. Si se omite, el cliente usa el `chain-id` de tu configuración local.
:::
