...
:::note
Los comandos siguientes apuntan a la testnet **`qorechain-diana`**. La mainnet (**`qorechain-vladi`**, EVM chain ID **9801**) está en producción desde el 7 de junio de 2026 ejecutando la versión de cadena **v3.1.82** — sustituye el chain ID y los endpoints de mainnet al desplegar en mainnet. Valida cada despliegue primero en testnet.
:::
