...
:::note
Los ejemplos siguientes apuntan a la mainnet **`qorechain-vladi`** (EVM chain ID **9801**), activa desde el 7 de junio de 2026 ejecutando la versión de cadena **v3.1.92**. Para la testnet **`qorechain-diana`**, usa el EVM chain ID **9800**.
:::
