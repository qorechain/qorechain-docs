...
:::danger El panel no tiene autenticación
El puerto 8420 escucha en **todas las interfaces**, no solo en localhost, y el panel **no tiene inicio de sesión ni control de acceso**. Cualquiera que pueda alcanzar el puerto en tu red puede leer tu configuración, delegaciones y recompensas. **No lo expongas públicamente.** Vincúlalo solo a loopback, o colócalo detrás de un proxy inverso que exija autenticación, antes de ejecutarlo en cualquier entorno que no sea una red privada totalmente confiable.
:::
