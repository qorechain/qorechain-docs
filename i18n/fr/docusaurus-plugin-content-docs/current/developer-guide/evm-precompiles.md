...
:::note
Les précompilés sont disponibles à la fois sur le mainnet **`qorechain-vladi`** (EVM chain ID **9801**, en service depuis le 7 juin 2026 sur la version de chaîne **v3.1.82**) et le testnet **`qorechain-diana`** (EVM chain ID **9800**). Tous les exemples utilisent le point de terminaison JSON-RPC sur le **port 8545**.
:::
