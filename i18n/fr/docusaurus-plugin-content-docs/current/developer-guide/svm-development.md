...
:::note
Les commandes ci-dessous utilisent le mainnet **`qorechain-vladi`**, en service depuis le 7 juin 2026 et exécutant la version de chaîne **v3.1.92**. Remplacez par `--chain-id qorechain-diana` pour le testnet.
:::
