...
:::note
Les commandes ci-dessous ciblent le testnet **`qorechain-diana`**. Le mainnet (**`qorechain-vladi`**, EVM chain ID **9801**) est en service depuis le 7 juin 2026 et exécute la version de chaîne **v3.1.82** — remplacez le chain ID et les endpoints du mainnet lors d'un déploiement sur le mainnet. Validez d'abord chaque déploiement sur le testnet.
:::
