...
:::note
Les commandes ci-dessous ciblent le testnet **`qorechain-diana`**. Le mainnet (**`qorechain-vladi`**, chain ID EVM **9801**) est en production depuis le 7 juin 2026 et exécute la version de chaîne **v3.1.97** — substituez le chain ID et les endpoints du mainnet lors d'un déploiement sur mainnet. Validez chaque déploiement sur testnet d'abord.
:::
