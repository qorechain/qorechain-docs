...
:::note
Les chiffres de cette page décrivent le **mainnet** (`qorechain-vladi`, EVM chain ID **9801**), en service depuis le 7 juin 2026 sur la version de chaîne **v3.1.85**. Le testnet **`qorechain-diana`** (EVM chain ID **9800**) partage le même modèle économique.
:::
