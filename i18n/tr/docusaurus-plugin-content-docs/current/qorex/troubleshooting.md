...
| **"Hesaplarınız" listesinden fonlu bir hesap kayboldu** | Hiçbir şey kaybolmadı — her hesap kurtarma ifadenizden yeniden türetilir, bu yüzden bu bir görüntüleme sorunudur, veri kaybı değildir. Bu, **1.0.9** öncesi mobil sürümlerde gerçek, artık düzeltilmiş bir hataydı: cihazın güvenli depolamasından anlık bir okuma hatası (büyük olasılıkla tam kilit açma anında) kısaltılmış bir hesap listesi göstermesine neden olabiliyordu. 1.0.9 veya sonrasına güncelleyin; zaten güncelse ve bu yine de olursa, uygulamayı kapatıp yeniden açmak listeyi geri getirmelidir — "hesap ekle"ye dokunmak, eksik olanı geri yüklemek yerine **yeni** bir hesap oluşturur, bu yüzden mevcut hesap tekrar görünene kadar bundan kaçının. |
