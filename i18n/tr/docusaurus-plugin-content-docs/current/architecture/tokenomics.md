...
:::note
Bu sayfadaki rakamlar, 7 Haziran 2026'dan beri zincir sürümü **v3.1.77** üzerinde çalışan **ana ağı** (`qorechain-vladi`, EVM zincir kimliği **9801**) tanımlar. **`qorechain-diana`** test ağı (EVM zincir kimliği **9800**) aynı ekonomik modeli paylaşır.
:::
