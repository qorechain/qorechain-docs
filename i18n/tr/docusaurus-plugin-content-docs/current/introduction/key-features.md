...
Aşağıdaki tablo, QoreChain'deki tüm büyük özellikleri, tanıtıldıkları sürüm aşamasına göre düzenlenmiş şekilde listeler. Mevcut zincir sürümü **v3.1.92**'dir; ana ağ (`qorechain-vladi`, EVM chain ID 9801) 7 Haziran 2026'dan beri yayında ve paralel bir test ağı (`qorechain-diana`, EVM chain ID 9800) çalışmaktadır.
