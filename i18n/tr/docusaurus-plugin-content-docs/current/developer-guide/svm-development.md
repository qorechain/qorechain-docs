...
:::note
Aşağıdaki komutlar, 7 Haziran 2026'dan bu yana canlı olan ve **v3.1.97** zincir sürümünü çalıştıran **`qorechain-vladi`** ana ağını (mainnet) kullanır. Test ağı (testnet) için `--chain-id qorechain-diana` kullanın.
:::
