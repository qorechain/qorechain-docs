...
:::note
프리컴파일은 **`qorechain-vladi`** 메인넷(EVM 체인 ID **9801**, 체인 버전 **v3.1.97**로 2026년 6월 7일부터 운영 중)과 **`qorechain-diana`** 테스트넷(EVM 체인 ID **9800**) 양쪽에서 모두 사용할 수 있습니다. 모든 예제는 **포트 8545**의 JSON-RPC 엔드포인트를 사용합니다.
:::
