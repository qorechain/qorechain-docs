...
:::note
아래 명령어는 **`qorechain-diana`** 테스트넷(EVM 체인 ID **9800**)을 기준으로 합니다. 메인넷(**`qorechain-vladi`**, EVM 체인 ID **9801**)은 2026년 6월 7일부터 체인 버전 **v3.1.95**로 가동 중입니다 — 메인넷에서 트랜잭션을 처리할 때는 **Connecting to Mainnet** 페이지에 나온 메인넷 체인 ID와 엔드포인트로 대체하세요.
:::
