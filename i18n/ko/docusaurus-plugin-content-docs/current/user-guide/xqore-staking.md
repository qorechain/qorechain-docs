...
:::note
아래 명령어는 **`qorechain-diana`** 테스트넷(EVM 체인 ID **9800**)을 기준으로 합니다. 메인넷(**`qorechain-vladi`**, EVM 체인 ID **9801**)은 2026년 6월 7일부터 가동 중이며 체인 버전 **v3.1.95**를 실행하고 있습니다. 메인넷에서 스테이킹할 때는 **메인넷 연결하기** 페이지에 안내된 메인넷 체인 ID와 엔드포인트로 대체하세요.
:::
