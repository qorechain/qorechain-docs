...
:::note
이 인터페이스들은 **`qorechain-vladi`** 메인넷(2026년 6월 7일부터 가동 중, 체인 버전 **v3.1.97**)과 **`qorechain-diana`** 테스트넷 모두에서 사용할 수 있습니다. 아래의 기본 URL은 로컬에서 실행 중인 노드를 기준으로 합니다. 공개 호스팅 엔드포인트(`rpc/api/evm/svm.qore.host` 및 해당 `-testnet` 변형)는 [네트워크](/appendix/networks#public-endpoints)에 정리되어 있습니다.
:::
