...
:::note
تصف الأرقام في هذه الصفحة **الشبكة الرئيسية** (`qorechain-vladi`، معرّف سلسلة EVM **9801**)، الحيّة منذ 7 يونيو 2026 على إصدار السلسلة **v3.1.82**. وتشترك شبكة الاختبار **`qorechain-diana`** (معرّف سلسلة EVM **9800**) في النموذج الاقتصادي نفسه.
:::
