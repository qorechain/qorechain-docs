...
:::note
تستهدف الأوامر أدناه شبكة الاختبار **`qorechain-diana`**. الشبكة الرئيسية (**`qorechain-vladi`**، بمعرّف سلسلة EVM رقم **9801**) تعمل منذ 7 يونيو 2026 على إصدار السلسلة **v3.1.97** — استبدل معرّف سلسلة الشبكة الرئيسية ونقاط الوصول الخاصة بها عند النشر على الشبكة الرئيسية. تحقق من كل عملية نشر على شبكة الاختبار أولاً.
:::
