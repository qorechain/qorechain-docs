...
:::note
تستهدف الأوامر أدناه الشبكة التجريبية **`qorechain-diana`**. أما الشبكة الرئيسية (**`qorechain-vladi`**، معرّف سلسلة EVM رقم **9801**) فهي قيد التشغيل منذ 7 يونيو 2026 وتعمل بإصدار السلسلة **v3.1.80** — استبدل معرّف السلسلة ونقاط النهاية الخاصة بالشبكة الرئيسية عند النشر عليها. تحقق من كل عملية نشر على الشبكة التجريبية أولاً.
:::
