...
بمجرد التسجيل والتفويض، يصبح الحفاظ على الأهلية مسألة بقاء نشطًا. تحتاج العقدة إلى نسبة تشغيل لا تقل عن **80%**، ويجب أن تستمر في إرسال إثباتات استمرارية النشاط بنبضات القلب على فترة تبلغ تقريبًا **1,000 كتلة (~39 دقيقة)**، مع **فترة سماح تبلغ نحو 100 كتلة (~4 دقائق)** بعد تفويت نبضة قلب قبل أن تُعلَّم العقدة غير نشطة. العقدة المُعلَّمة غير نشطة تتوقف عن كسب الحصة حتى تُثبت النشاط مرة أخرى.
