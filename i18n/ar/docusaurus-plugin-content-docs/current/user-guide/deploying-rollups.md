...
:::note
تستخدم الأوامر أدناه الشبكة التجريبية **`qorechain-diana`** (معرّف سلسلة EVM **9800**). الشبكة الرئيسية (**`qorechain-vladi`**، معرّف سلسلة EVM **9801**) تعمل منذ 7 يونيو 2026 بإصدار السلسلة **v3.1.97** — استبدل معرّف السلسلة ونقاط النهاية الخاصة بالشبكة الرئيسية من صفحة **الاتصال بالشبكة الرئيسية** عند النشر عليها.
:::
