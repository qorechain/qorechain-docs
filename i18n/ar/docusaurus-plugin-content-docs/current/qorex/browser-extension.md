...
|---|---|
| **Firefox** | **0.1.8** (تم إرسال 0.1.9 وهو قيد المراجعة) |
| **Chrome / Chromium** | **0.1.5** (تم إرسال 0.1.9 وهو قيد المراجعة) |
| **Safari (macOS)** | يُشحن داخل تطبيق **QoreX Wallet** لنظام macOS، الذي يستخدم ترقيمه الخاص `1.x` — يقدّم Mac App Store حاليًا **1.1** (يحمل الإضافة 0.1.5)؛ أما **1.2** (الذي يحمل 0.1.9) فهو مُرسَل وقيد المراجعة |

قد لا تكون الميزات الأحدث متاحة في متصفحك بعد — راجع الجدول أعلاه قبل افتراض توفر شيء موصوف هنا.
...
:::note حساب واحد لكل ملف تعريف متصفح
بخلاف تطبيق الهاتف المحمول، الذي يمكنه الاحتفاظ بعدة حسابات QoreChain من عبارة استرداد واحدة، تدير الإضافة حسابًا **واحدًا** بالضبط. الرهن (Staking)، والمحفظة الاستثمارية (Portfolio)، وماسح Q-Day، والاسترداد الاجتماعي، وبروتوكول Legacy، وطلبات الدفع، وربط الأجهزة كلها حصرية لتطبيق الهاتف — راجع [محفظة QoreX](/qorex/overview#platform-availability) للمقارنة الكاملة.
:::
