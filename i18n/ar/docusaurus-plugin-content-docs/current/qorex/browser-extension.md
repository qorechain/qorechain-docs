...
| **Chrome / Chromium** | ظلّت عالقة خلف مراجعة متجر طويلة حتى أواخر أغسطس — راجع [صفحة Chrome Web Store](https://chromewebstore.google.com/detail/qorex/cflpnggbnnifibblifgbeobogdpfjpcg) مباشرة لمعرفة إصدارها الحالي بدلًا من الاعتماد على أي رقم هنا |
...
5. منذ الإصدار **0.2.6**، يمكنك أيضًا **نقل الرهن إلى مدقّق مختلف** (إعادة التفويض) — دون انتظار إلغاء الربط ودون أي عقوبة، مع استمرار تدفق المكافآت طوال الطريق. راجع [نقل الرهن بين المدقّقين](/qorex/portfolio-and-staking#move-stake) لمعرفة كيفية عمل ذلك (الآلية متطابقة بين التطبيق والإضافة).
