...
:::note
تتوفّر كلتا واجهتي WebSocket على شبكة **`qorechain-vladi`** الرئيسية (تعمل على إصدار السلسلة **v3.1.77**) وشبكة **`qorechain-diana`** الاختبارية. تفترض نقاط النهاية المحلية أدناه عقدة تشغّلها بنفسك؛ استبدلها بمضيف الشبكة الرئيسية أو الاختبارية الخاص بمزوّدك للوصول عن بُعد.
:::
