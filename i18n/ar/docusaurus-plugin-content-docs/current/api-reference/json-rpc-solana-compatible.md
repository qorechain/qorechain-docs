...
:::note
اعتبارًا من إصدار السلسلة **v3.1.85**، تخدم واجهة SVM **رصيد QOR الأصلي** للحساب — وهو نفس الأموال الموحّدة الظاهرة على واجهتَي Cosmos وEVM — مقوَّمًا بوحدة **lamports** (9 منازل عشرية؛ **1 uqor = 1,000 lamports**). راجع [QOR الأصلي على واجهة SVM](/developer-guide/svm-development#native-qor).
:::
