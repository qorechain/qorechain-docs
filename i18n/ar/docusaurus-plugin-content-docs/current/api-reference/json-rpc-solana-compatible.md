...
:::note
تُقدَّم واجهة JSON-RPC المتوافقة مع Solana على المنفذ **8899** من كلٍّ من شبكة **`qorechain-vladi`** الرئيسية (تعمل على إصدار السلسلة **v3.1.77**) وشبكة **`qorechain-diana`** الاختبارية. ينطبق العنوان المحلي أعلاه على عقدة تشغّلها بنفسك؛ استبدله بنقطة نهاية الشبكة الرئيسية أو الاختبارية الخاصة بمزوّدك للوصول عن بُعد.
:::
