...
:::note
الأمثلة أدناه تستهدف الشبكة الرئيسية **`qorechain-vladi`** (معرّف سلسلة EVM **9801**)، وهي قيد التشغيل منذ 7 يونيو 2026 بإصدار السلسلة **v3.1.82**. لشبكة الاختبار **`qorechain-diana`**، استخدم معرّف سلسلة EVM **9800**.
:::
