...
:::note
تستهدف الأمثلة أدناه شبكة **`qorechain-vladi`** الرئيسية (معرّف سلسلة EVM **9801**)، العاملة منذ 7 يونيو 2026 وتشغّل إصدار السلسلة **v3.1.92**. لشبكة الاختبار **`qorechain-diana`**، استخدم معرّف سلسلة EVM **9800**.
:::
