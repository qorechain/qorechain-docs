...
:::note
المعالِجات المسبقة متاحة على كل من الشبكة الرئيسية **`qorechain-vladi`** (معرّف سلسلة EVM **9801**، قيد التشغيل منذ 7 يونيو 2026 بإصدار السلسلة **v3.1.85**) وشبكة الاختبار **`qorechain-diana`** (معرّف سلسلة EVM **9800**). جميع الأمثلة تستخدم نقطة نهاية JSON-RPC على **المنفذ 8545**.
:::
