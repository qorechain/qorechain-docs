...
اعتبارًا من إصدار السلسلة **v3.1.85**، أصبحت واجهة SVM **واجهة QOR أصلية من الدرجة الأولى**، وليست رصيدًا منفصلًا في بيئة معزولة. الرصيد الموحّد الوحيد للحساب — وهو نفس الأموال المرئية بوحدة `uqor` على واجهة Cosmos وبوحدة wei ذات 18 خانة عشرية على EVM — يظهر على جانب SVM بوحدة **lamports** (9 خانات عشرية):
