...
:::note
تستخدم الأوامر أدناه شبكة **`qorechain-vladi`** الرئيسية، النشطة منذ 7 يونيو 2026 وتشغّل إصدار السلسلة **v3.1.80**. استبدلها بـ `--chain-id qorechain-diana` لشبكة الاختبار.
:::
