...
نشر عقدة-فقط باستخدام Docker Compose. ثبّت وسم الصورة على إصدار السلسلة الحي (**v3.1.80** على الشبكة الرئيسية) وركّب وحدة تخزين دائمة لبيانات السلسلة.
...
1. **ثبّت إصدار السلسلة.** شغّل الوسم الحي (**v3.1.80** على الشبكة الرئيسية) وتتبّع الإصدارات الرسمية للترقيات المنسّقة.
