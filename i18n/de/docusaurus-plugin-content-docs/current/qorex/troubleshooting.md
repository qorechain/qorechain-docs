...
| **Ein finanziertes Konto ist aus „Ihre Konten" verschwunden** | Nichts ist verloren gegangen — jedes Konto wird erneut aus Ihrer Wiederherstellungsphrase abgeleitet, es handelt sich also um ein Anzeigeproblem, nicht um Datenverlust. Dies war ein echter, inzwischen behobener Fehler in mobilen Builds vor **1.0.9**: Ein kurzzeitig fehlgeschlagener Lesevorgang aus dem sicheren Speicher des Geräts (höchstwahrscheinlich genau beim Entsperren) konnte eine verkürzte Kontenliste anzeigen. Aktualisieren Sie auf 1.0.9 oder höher; falls Sie bereits auf dem aktuellen Stand sind und dies dennoch auftritt, sollte das Schließen und erneute Öffnen der App die Konten wieder anzeigen — das Antippen von „Konto hinzufügen" würde ein **neues** Konto erstellen, anstatt das fehlende wiederherzustellen, vermeiden Sie dies also, bis das vorhandene Konto wieder erscheint. |
