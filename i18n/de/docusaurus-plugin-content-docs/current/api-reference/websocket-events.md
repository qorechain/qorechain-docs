...
:::note
Beide WebSocket-Schnittstellen sind im **`qorechain-vladi`**-Mainnet (live auf Chain-Version **v3.1.85**) und im **`qorechain-diana`**-Testnet verfügbar. Die untenstehenden lokalen Endpunkte gehen von einem Node aus, den Sie selbst betreiben; ersetzen Sie für den Fernzugriff den Mainnet- oder Testnet-Host Ihres Anbieters.
:::
