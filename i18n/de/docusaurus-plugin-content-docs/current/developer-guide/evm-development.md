...
:::note
Die folgenden Beispiele richten sich an das **`qorechain-vladi`**-Mainnet (EVM-Chain-ID **9801**), das seit dem 7. Juni 2026 live ist und Chain-Version **v3.1.97** ausführt. Für das **`qorechain-diana`**-Testnet verwenden Sie die EVM-Chain-ID **9800**.
:::
