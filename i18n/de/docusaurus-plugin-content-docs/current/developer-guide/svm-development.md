...
:::note
Die folgenden Befehle verwenden das **`qorechain-vladi`**-Mainnet, das seit dem 7. Juni 2026 live ist und die Chain-Version **v3.1.95** ausführt. Ersetzen Sie `--chain-id qorechain-diana` für das Testnet.
:::
