...
:::note
Die folgenden Befehle verwenden das **`qorechain-vladi`**-Mainnet, das seit dem 7. Juni 2026 mit der Chain-Version **v3.1.77** in Betrieb ist. Ersetzen Sie `--chain-id qorechain-diana` für das Testnet.
:::
