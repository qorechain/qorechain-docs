...
:::note
Die folgenden Befehle verwenden das **`qorechain-vladi`**-Mainnet, live seit dem 7. Juni 2026 mit der Chain-Version **v3.1.95**. Ersetzen Sie für das Testnet `--chain-id qorechain-diana`.
:::
