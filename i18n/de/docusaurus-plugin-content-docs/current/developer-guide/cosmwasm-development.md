...
:::note
Die folgenden Befehle verwenden das **`qorechain-vladi`**-Mainnet, live seit dem 7. Juni 2026, auf dem die Chain-Version **v3.1.95** läuft. Ersetzen Sie `--chain-id qorechain-diana` für das Testnet.
:::
