...
:::note
QoreChain betreibt zwei Netzwerke: das **`qorechain-vladi`**-Mainnet (live seit 7. Juni 2026 auf Chain-Version **v3.1.97**) und das **`qorechain-diana`**-Testnet. Übergeben Sie die passende `--chain-id` für das Netzwerk, dem Sie beitreten möchten — die folgenden Beispiele zielen auf das Testnet ab; verwenden Sie `--chain-id qorechain-vladi` für das Mainnet.
:::
