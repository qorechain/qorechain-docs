...
:::note
Die folgenden Befehle richten sich an das **`qorechain-diana`**-Testnet. Das Mainnet (**`qorechain-vladi`**, EVM-Chain-ID **9801**) läuft seit dem 7. Juni 2026 live mit Chain-Version **v3.1.97** — ersetzen Sie beim Deployment auf dem Mainnet die Chain-ID und die Endpunkte entsprechend. Validieren Sie jedes Deployment zuerst auf dem Testnet.
:::
