...
:::note
I comandi seguenti utilizzano la mainnet **`qorechain-vladi`**, attiva dal 7 giugno 2026 con la versione di chain **v3.1.85**. Sostituisci con `--chain-id qorechain-diana` per la testnet.
:::
