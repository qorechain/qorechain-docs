...
:::note
Le cifre riportate in questa pagina descrivono la **mainnet** (`qorechain-vladi`, EVM chain ID **9801**), live dal 7 giugno 2026 sulla versione della chain **v3.1.97**. La testnet **`qorechain-diana`** (EVM chain ID **9800**) condivide lo stesso modello economico.
:::
